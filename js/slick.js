$(".home-index-slider").slick({
    ...
    $(".new-slider").slick({
        ...
        responsive: [
            ...
            { breakpoint: 992, settings: { slidesToShow: 3, slidesToScroll: 3 } },
            { breakpoint: 768, settings: { slidesToShow: 2, slidesToScroll: 2 } },
            { breakpoint: 576, settings: { slidesToShow: 1, slidesToScroll: 1, variableWidth: !0, arrows: !1 } },
        ],
    }),
	$(".combo-meal").slick({
        dots: !1,
        ...
        responsive: [
            ...
            { breakpoint: 992, settings: { slidesToShow: 3, slidesToScroll: 3 } },
            { breakpoint: 768, settings: { slidesToShow: 2, slidesToScroll: 2 } },
            { breakpoint: 576, settings: { slidesToShow: 1, slidesToScroll: 1, variableWidth: !100, arrows: !1 } },
        ],
    }),
	$(".latest-offers").slick({
        dots: !1,
    ...
    $(".category-slider").slick({
        ...
        responsive: [
            ...
            { breakpoint: 576, settings: { slidesToShow: 2, slidesToScroll: 2, variableWidth: !0, arrows: !1 } },
        ],
    }),
    $(".brand-slider").slick({
        dots: !1,
        ...
        responsive: [
            ...
            { breakpoint: 992, settings: { slidesToShow: 3, slidesToScroll: 3 } },
            { breakpoint: 768, settings: { slidesToShow: 2, slidesToScroll: 2 } },
            { breakpoint: 576, settings: { slidesToShow: 2, slidesToScroll: 1, variableWidth: !0, arrows: !1 } },
        ],
    }),
    $(".blog-slider").slick({
        dots: !1,
    ...
    $(".testimonial-slider").slick({
        ...
        responsive: [
            ...
            { breakpoint: 576, settings: { arrows: !1, slidesToShow: 1, slidesToScroll: 1, centerPadding: "10px" } },
        ],
    }),
    $(".testi-slider").slick({
        dots: !1,
    ...
    $(".preview-slider").slick({
        ...
        prevArrow: '<i class="icofont-arrow-right dandik"></i>',
        nextArrow: '<i class="icofont-arrow-left bamdik"></i>',
        responsive: [{ breakpoint: 576, settings: { slidesToShow: 1, slidesToScroll: 1, arrows: !0 } }],
    }),
    $(".thumb-slider").slick({
        slidesToShow: 3,
        slidesToScroll: 1,
    ...
    $(".details-thumb").slick({
        ...
        responsive: [
            ...
            { breakpoint: 576, settings: { slidesToShow: 4, slidesToScroll: 1, vertical: !1 } },
            { breakpoint: 400, settings: { slidesToShow: 3, slidesToScroll: 1, vertical: !1 } },
        ],
    });
